...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        %       obj.NotTermination(Population)
            ...
            index = max(1,min(min(40,size(obj.result,1)+1),ceil(40*obj.evaluated/obj.evaluation)));
    ...
    methods(Access = private, Static)
        ...
        function save(obj)
            ...
            if obj.evaluated >= obj.evaluation
                ...
                save(fullfile(folder,sprintf('%s_%s_%d.mat',func2str(obj.algorithm),func2str(obj.problem),obj.run)),'Result','metric');
            end
        end
